<div class="left-side sticky-left-side">
    ...
    <div class="left-side-inner">
        <ul class="nav nav-pills nav-stacked custom-nav">
            ...
            <li class="menu-list"><a href="browse.html"><i class="lnr lnr-indent-increase"></i> <span>Categories</span></a>  
            ...
            <li><a href="{{route('artist.index')}}"><i class="lnr lnr-users"></i> <span>Artists</span></a></li>
