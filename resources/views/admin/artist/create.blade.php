...
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{route('admin.artist.create')}}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="form-group">
                <label class="control-label">{{ trans('messages.name_title') }}</label>
                <div class="">
                    <input type="text" name="Artist[name]" class="form-control" value="{{old('Artist.name')}}" required>
            ...
            <div class="input-group form-group date" data-provide="datepicker">
                ...
                <input type="text" class="form-control" id="datepicker" placeholder="{{ trans('messages.dob_title') }}" name="Artist[dob]" readonly>
            ...
            <div class="form-group">
                ...
                <div class="">
                    <textarea type="text" name="Artist[information]" class="form-control" value="{{old('Artist.information')}}" rows="5" required> </textarea>
